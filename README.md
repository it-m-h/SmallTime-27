...
- **Lizenz:** privat bis 2 Personen dauerhaft gratis. Firmen, Vereine, Nonprofit-Organisationen, öffentliche Stellen und Selbständige brauchen immer einen Lizenzschlüssel. Er wird jährlich verrechnet, gestaffelt nach Anzahl aktiver Personen. Preise und Bedingungen stehen auf [small.li](https://small.li). Details: [LICENSE](LICENSE).
